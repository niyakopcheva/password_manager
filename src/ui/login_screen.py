...
class LoginWindow(ctk.CTk):
    def __init__(self):
        ...
        self.password_entry = ctk.CTkEntry(self, placeholder_text="Master Password", show="*", width=250)
        self.password_entry.grid(row=5, column=0, padx=20, pady=(0, 10))

        # Error Label
        self.error_label = ctk.CTkLabel(self, text="", text_color="#fd4141")
        self.error_label.grid(row=6, column=0, padx=20, pady=0)

        # Login Button
        self.login_button = ctk.CTkButton(self, text="Login", command=self.handle_login)
        self.login_button.grid(row=7, column=0, padx=20, pady=10)

        # -or- 
        self.or_label = ctk.CTkLabel(self, text="- or -", text_color=("gray50", "gray70"))
        self.or_label.grid(row=8, column=0, pady=(0, 10))
        ...
        self.register_link.grid(row=9, column=0, padx=20, pady=(0, 10))
    ...
    def show_register_ui(self):
        ...
        self.register_button.grid(row=9, column=0, padx=20, pady=(0, 10))
